...
const Hero = () => {
  ...
  return (
    <main className="bg-[#eceeec] h-full" id="intro">
      ...
      <div className="flex">
        {/* Text Section */}
        <div className="w-[50%] flex flex-col justify-center items-center ml-16">
          <div>
            <h1 className="text-[#c9401c] text-left text-3xl font-sans">Hello</h1>
            <p className="font-serif text-7xl break-words w-12/12 2xl:w-9/12 text-left">
              I'm Courage Nduka, a software Developer based in Lagos, Nigeria
            </p>
            <span className="flex gap-7 mt-10">
      ...
      {/* Call to Action */}
      <div className="absolute inset-1/2 -translate-x-full 2xl:mt-96 mt-72 -translate-y-1/2 w-80 ml-56">
