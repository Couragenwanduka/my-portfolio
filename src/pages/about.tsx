const About = () => {
    return (
      <main className="p-16" id="about-me">
        {/* About Section */}
        <section className="mb-20 mt-16">
          <div>
            <h1 className="text-[200px] font-bold text-[#e7e9e7] font-sans">01</h1>
            <p className="text-5xl text-black absolute top-[150%] 2xl:top-[147%] ml-4 font-serif">About Me.</p>
          </div>
       ...
       <section className="flex justify-between">
          {/* Experience Section */}
        <section className="mb-12 flex flex-col justify-ceter items-center">
